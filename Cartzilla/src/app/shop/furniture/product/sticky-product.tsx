...
const StickyProductFurniture = ({ product }: { product: Product }) => {
    ...
    <>
      <section ref={stickyElementRef} className={`sticky-product-banner sticky-top${isStuck ? ' is-stuck' : ''}`}>
        <div className="sticky-product-banner-inner pt-5">
          <div className="navbar flex-nowrap align-items-center bg-body pt-4 pb-2">
            <div className="d-flex align-items-center min-w-0 ms-lg-2 me-3">
              <Ratio aspectRatio="1x1" className="flex-shrink-0" style={{ width: 50 }}>
                <Image src="/img/shop/furniture/product/thumb.png" width={100} height={100} alt="Image" />
              </Ratio>
            ...
            <div className="d-flex gap-2">
              <Button
                variant="secondary"
                className="btn-icon animate-pulse rounded-circle"
              ...
              <Button
                variant="dark"
                className="d-none d-md-inline-flex rounded-pill ms-auto px-4"
              ...
              <Button
                variant="dark"
                className="btn-icon animate-slide-end rounded-circle ms-auto d-md-none"
...
export default StickyProductFurniture
